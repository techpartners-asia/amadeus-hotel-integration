...
func (r *HotelListByGeocodeRequest) ToQueryParams() map[string]string {
	return map[string]string{
		"cityCode":    r.CityCode,
		"radius":      strconv.Itoa(r.Radius),
		"radiusUnit":  r.RadiusUnit,
		"chainCodes":  strings.Join(r.ChainCodes, ","),
		"amenities":   strings.Join(r.Amenities, ","),
		"ratings":     strings.Join(r.Ratings, ","),
		"hotelSource": r.HotelSource,
	}
}
